<template>
    <BackOfficePageContent nomPage="Ajouter un type d'acteur">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Types d'acteur", nomRoute: "acteur.acteur-types.list", parametres: {}},
            ...
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            ...
                            this.loading = false;
                            this.$router.push({name: "acteur.acteur-types.list", query: { alertSucces: 'Item créé avec succès' }});
                        })
                        .catch(e => {
                            this.loading = false;
