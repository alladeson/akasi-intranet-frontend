<template>
    <BackOfficePageContent nomPage="Types d'acteur">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">                        
                        <div class="col-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'acteur.acteur-types.create'}"/>
                        </div>
                        <div class="col-md-6">
                            <!-- Autres filtres -->
                        </div>
...
<script>
    import DataService from "@/services/BackOffice/Acteur/ActeurType/ActeurTypeDataService";
    ...
    export default {
        ...
        data() {
            return {
                ...
                uuid: "",
                boutonsAction: [
                    //{nom: "show", nomRoute: "acteur.acteur-types.edit", classe: "btn btn-secondary btn-sm"},
                    {nom: "edit", nomRoute: "acteur.acteur-types.edit", classe: ""},
                    {nom: "delete", nomRoute: "", classe: ""},
                ],
                listeBreadcrumbs: [
                    {texte: "Tableau de bord", nomRoute: "dashboard", parametres: {}},
                    {texte: "Typtes d'acteur", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
