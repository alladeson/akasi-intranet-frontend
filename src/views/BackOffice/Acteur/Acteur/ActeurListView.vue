<template>
    <BackOfficePageContent nomPage="Liste des acteurs">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">                        
                        <div class="col-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'acteur.acteurs.create'}"/>
                        </div>
                        <div class="col-md-6">
                            <!-- Autres filtres -->
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                uuid: "",
                boutonsAction: [
                    //{nom: "show", nomRoute: "acteur.acteurs.edit", classe: "btn btn-secondary btn-sm"},
                    {nom: "edit", nomRoute: "acteur.acteurs.edit", classe: ""},
                    {nom: "delete", nomRoute: "", classe: ""},
                ],
                listeBreadcrumbs: [
                    {texte: "Tableau de bord", nomRoute: "dashboard", parametres: {}},
                    {texte: "Liste des acteurs", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
