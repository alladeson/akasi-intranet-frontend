<template>
    <BackOfficePageContent nomPage="Categories d'acteur">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">                        
                        <div class="col-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'acteur.acteur-categories.create'}"/>
                        </div>
                        <div class="col-md-6">
                            <!-- Autres filtres -->
                        </div>
...
<script>
    import DataService from "@/services/BackOffice/Acteur/ActeurCategorie/ActeurCategorieDataService";
    ...
    export default {
        ...
        data() {
            return {
                ...
                uuid: "",
                boutonsAction: [
                    //{nom: "show", nomRoute: "acteur.acteur-categories.edit", classe: "btn btn-secondary btn-sm"},
                    {nom: "edit", nomRoute: "acteur.acteur-categories.edit", classe: ""},
                    {nom: "delete", nomRoute: "", classe: ""},
                ],
                listeBreadcrumbs: [
                    {texte: "Tableau de bord", nomRoute: "dashboard", parametres: {}},
                    {texte: "Catégories d'acteur", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
