<template>
    <BackOfficePageContent nomPage="Editer une catégorie d'acteur">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Catégorie d'acteur", nomRoute: "acteur.acteur-categories.list", parametres: {}},
            ...
            bdObjetSave(e) {
                ...
                DataService.update(this.bdObjet.uuid, this.bdObjet)
                        .then(response => {
                            ...
                            this.$router.push({name: "acteur.acteur-categories.list", query: { alertSucces: 'Item mis à jour avec succès' }});
                            this.loading = false;
                        })
                        .catch(e => {
                            this.loading = false;
