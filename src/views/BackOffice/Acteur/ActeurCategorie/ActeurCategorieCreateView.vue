<template>
    <BackOfficePageContent nomPage="Ajouter une catégorie d'acteur">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Catégories d'acteur", nomRoute: "acteur.acteur-categories.list", parametres: {}},
            ...
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            ...
                            this.loading = false;
                            this.$router.push({name: "acteur.acteur-categories.list", query: { alertSucces: 'Item créé avec succès' }});
                        })
                        .catch(e => {
                            this.loading = false;
