<template>
    <BackOfficePageContent nomPage="Ajouter un attribut de détail d'étape">
...
<script>
    ...
    export default {
        name: "EtapeDetailAttributCreate",
        components: {
            ...
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            ...
                            this.loading = false;
                            this.$router.push({name: "etape.etape-detail-attributs.list", query: {alertSucces: 'Item créé avec succès'}});
                        })
                        .catch(e => {
                            this.loading = false;
