<template>
    <BackOfficePageContent nomPage="Attributs de détails étapes">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">                        
                        <div class="col-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'etape.etape-detail-attributs.create'}"/>
                        </div>
                        <div class="col-md-6">
                            <!-- Autres filtres -->
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                uuid: "",
                boutonsAction: [
                    //{nom: "show", nomRoute: "etape.etape-detail-attributs.edit", classe: "btn btn-secondary btn-sm"},
                    {nom: "edit", nomRoute: "etape.etape-detail-attributs.edit", classe: ""},
                    {nom: "delete", nomRoute: "", classe: ""},
                ],
                listeBreadcrumbs: [
                    {texte: "Tableau de bord", nomRoute: "dashboard", parametres: {}},
                    {texte: "Attributs de détails étapes", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
