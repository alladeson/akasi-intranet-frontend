<template>
    <BackOfficePageContent nomPage="Editer un support d'information">
            ...
            bdObjetSave(e) {
                ...
                DataService.update(this.bdObjet.uuid, this.bdObjet)
                        .then(response => {
                            ...
                            this.$router.push({name: "etape.information-supports.list", query: { alertSucces: 'Item mis à jour avec succès' }});
                            this.loading = false;
                        })
                        .catch(e => {
                            this.loading = false;
