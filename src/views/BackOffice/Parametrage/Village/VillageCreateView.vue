<template>
    <BackOfficePageContent nomPage="Ajouter un village">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Créer un village", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            this.loading = false;
                            this.$router.push({name: "parametrage.villages.list", query: {alertSucces: 'Item créé avec succès'}});
                        })
                        .catch(e => {                            
