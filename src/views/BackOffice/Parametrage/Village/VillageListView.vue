<template>
    <BackOfficeLayoutClusterSlot nomPage="Villages" >
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                <div class="card-header border-transparent">
                    <h3 class="card-title">Liste des villages</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <!-- Select option -->
                        <div class="col-md-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'parametrage.villages.create'}"/>
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-6">
...
<script src="./VillageList.js"></script>
