<template>
    <BackOfficeLayoutClusterSlot nomPage="Pays" >
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <!-- Select option -->
                        <div class="col-md-12">
                            <!-- <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'parametrage.pays.create'}"/> -->
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-6">
