<template>
    <BackOfficePageContent nomPage="Editer une commune">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Éditer une commune", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
            bdObjetGet(uuid) {
                DataService.get(uuid)
                        .then(response => {
                            ...
                            this.uuid = uuid;
                            this.bdObjet.departement_id = this.bdObjet.departement.uuid
                        })
                        .catch(e => {
                        });
            },
            bdObjetSave() {
                ...
                DataService.update(this.uuid, this.bdObjet)
                        .then(response => {
                            this.$router.push({name: "parametrage.communes.list", query: {alertSucces: 'Item mis à jour avec succès'}});
                            this.loading = false;
                        })
                        .catch(e => {
