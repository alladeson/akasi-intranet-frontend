<template>
    <BackOfficeLayoutClusterSlot nomPage="Communes" >
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <!-- Select option -->
                        <div class="col-md-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'parametrage.communes.create'}"/>
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-6">
...
<script src="./CommuneList.js"></script>
