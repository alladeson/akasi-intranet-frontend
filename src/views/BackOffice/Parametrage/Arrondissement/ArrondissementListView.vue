<template>
    <BackOfficeLayoutClusterSlot nomPage="Arrondissements" >
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                <div class="card-header border-transparent">
                    <h3 class="card-title">Liste des arrondissements</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <!-- Select option -->
                        <div class="col-md-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'parametrage.arrondissements.create'}"/>
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-6">
...
<script src="./ArrondissementList.js"></script>
