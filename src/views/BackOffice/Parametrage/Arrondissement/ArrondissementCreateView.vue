<template>
    <BackOfficePageContent nomPage="Ajouter un arrondissement">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Créer un arrondissement", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            this.loading = false;
                            this.$router.push({name: "parametrage.arrondissements.list", query: {alertSucces: 'Item créé avec succès'}});
                        })
                        .catch(e => {                            
