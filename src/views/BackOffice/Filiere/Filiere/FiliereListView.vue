<template>
    <BackOfficePageContent nomPage="Filières">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">                        
                        <div class="col-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'filiere.filieres.create'}"/>
                        </div>
                        <div class="col-md-6">
                            <!-- Autres filtres -->
                        </div>
...
<script>
    import DataService from "@/services/BackOffice/Filiere/Filiere/FiliereDataService";
    ...
    export default {
        ...
        data() {
            return {
                ...
                uuid: "",
                boutonsAction: [
                    //{nom: "show", nomRoute: "filiere.filieres.edit", classe: "btn btn-secondary btn-sm"},
                    {nom: "edit", nomRoute: "filiere.filieres.edit", classe: ""},
                    {nom: "delete", nomRoute: "", classe: ""},
                ],
                listeBreadcrumbs: [
                    {texte: "Tableau de bord", nomRoute: "dashboard", parametres: {}},
                    {texte: "Filieres", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
