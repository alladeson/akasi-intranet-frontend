<template>
    <BackOfficePageContent nomPage="Editer une filière">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Filières", nomRoute: "filiere.filieres.list", parametres: {}},
        ...
        methods: {
            ...
            bdObjetSave() {
                ...
                DataService.update(this.uuid, this.bdObjet)
                        .then(response => {
                            this.$router.push({name: "filiere.filieres.list", query: {alertSucces: 'Item mis à jour avec succès'}});
                            this.loading = false;
                        })
                        .catch(e => {
                            this.loading = false;
