<template>
    <BackOfficePageContent nomPage="Ajouter un variété de filière">
            ...
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            ...
                            this.loading = false;
                            this.$router.push({name: "filiere.filiere-varietes.list", query: { alertSucces: 'Item créé avec succès' }});
                        })
                        .catch(e => {
                            this.loading = false;
