<template>
    <BackOfficePageContent nomPage="Variétés de filière">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">                        
                        <div class="col-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'filiere.filiere-varietes.create'}"/>
                        </div>
                        <div class="col-md-6">
                            <!-- Autres filtres -->
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                uuid: "",
                boutonsAction: [
                    //{nom: "show", nomRoute: "filiere.filiere-varietes.edit", classe: "btn btn-secondary btn-sm"},
                    {nom: "edit", nomRoute: "filiere.filiere-varietes.edit", classe: ""},
                    {nom: "delete", nomRoute: "", classe: ""},
                ],
                listeBreadcrumbs: [
                    {texte: "Tableau de bord", nomRoute: "dashboard", parametres: {}},
                    {texte: "Variétés de filière", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
