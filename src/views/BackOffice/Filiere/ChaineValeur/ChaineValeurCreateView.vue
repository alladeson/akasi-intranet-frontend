<template>
    <BackOfficePageContent nomPage="Ajouter une chaîne de valeur">
                ...
                <div class="card-body">
                    <form @submit.prevent="bdObjetSave" id="form-premier">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <AgBaseInputDateComponent nom="date_fin" label="Date de fin" v-model="bdObjet.date_fin" :required="false" disabled readonly/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Créer une chaîne de valeur", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            this.loading = false;
                            this.$router.push({name: "filiere.chaine_valeurs.list", query: {alertSucces: 'Item créé avec succès'}});
                        })
                        .catch(e => {                            
