<template>
  <BackOfficePageContent nomPage="Ajouter un type de produit fini">
  ...
  data() {
    return {
      ...
      listeBreadcrumbs: [
        ...
        {
          texte: "Liste des type de produits finis",
          nomRoute: "produit.produit-fini-types.list",
          parametres: {},
        },
        { texte: "Ajouter un type", nomRoute: "", parametres: {} },
      ],
    };
  },
  methods: {
