<template>
    <BackOfficePageContent nomPage="Editer un type de produit fini">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Liste des type de produits finis", nomRoute: "produit.produit-fini-types.list", parametres: {}},
                    {texte: "Editer un type", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
            ...
            bdObjetSave() {
                ...
                DataService.update(this.uuid, this.bdObjet)
                        .then(response => {
                            this.$router.push({name: "produit.produit-fini-types.list", query: {alertSucces: 'Item mis à jour avec succès'}});
                            this.loading = false;
                        })
                        .catch(e => {
                            this.loading = false;
