<template>
    <BackOfficePageContent nomPage="Liste des types de produits finis">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">                        
                        <div class="col-12">
                            <AgBaseButtonAddComponent ref="refAgBaseButtonAdd" :routerLink="{name: 'produit.produit-fini-types.create'}"/>
                        </div>
                        <div class="col-md-6">
                            <!-- Autres filtres -->
                        </div>
...
<script>
    import DataService from "@/services/BackOffice/Produit/ProduitFiniType/ProduitFiniTypeDataService";
    ...
    export default {
        ...
        data() {
            return {
                ...
                uuid: "",
                boutonsAction: [
                    //{nom: "show", nomRoute: "produit.produit-fini-types.edit", classe: "btn btn-secondary btn-sm"},
                    {nom: "edit", nomRoute: "produit.produit-fini-types.edit", classe: ""},
                    {nom: "delete", nomRoute: "", classe: ""},
                ],
                listeBreadcrumbs: [
                    {texte: "Tableau de bord", nomRoute: "dashboard", parametres: {}},
                    {texte: "Liste des types de produits finis", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
