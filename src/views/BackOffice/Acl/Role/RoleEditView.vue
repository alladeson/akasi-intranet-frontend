<template>
    <BackOfficePageContent nomPage="Editer un rôle">
        ...
        <template v-slot:MainContent>
            ...
            <div class="card">
                <div class="card-body">
                     <form class="" @submit.prevent="bdObjetSaveUpdateRole" id="form-premier">
                        ...
                        <div class="card card-secondary">
                            ...
                            <template v-for="(permission_groupe, pg) in permission_groupes" :key="pg">
                                <RoleEditGroupeComponent v-show="JSON.stringify(inlineFilterSearch).indexOf(permission_groupe.groupe) > -1" 
                                    :bdObjet="bdObjet" 
