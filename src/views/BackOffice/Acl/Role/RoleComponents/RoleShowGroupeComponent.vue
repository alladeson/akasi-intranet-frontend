            ...
            <div class="container">
                <div class="row">
                    <template v-for="(item, i) in inlineFilterSearchChild" :key="i">
                        <div class="col-sm-3">
                            <RoleShowGroupeCheckboxComponent :bdObjetPermissions="bdObjet.permissions"
...
<script>
    import RoleShowGroupeCheckboxComponent from "@/views/BackOffice/Acl/Role/RoleComponents/RoleShowGroupeCheckboxComponent.vue";
    export default {
        name: "RoleShowGroupeComponent",
        components: {
            RoleShowGroupeCheckboxComponent,
        },
        props: {
            bdObjet: {
                type: Object,
