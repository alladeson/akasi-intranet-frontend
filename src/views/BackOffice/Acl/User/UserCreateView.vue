<template>
    <BackOfficePageContent nomPage="Ajouter un intervenant">
                            ...
                            <form @submit.prevent="bdObjetSave" class="row col-lg-12 col-md-12" id="form-premier">
                                <div class="col col-lg-6 col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <AgBaseInputNumberComponent nom="tel_mobile" label="Téléphone mobile" v-model="bdObjet.tel_mobile" minlength="7" :required="true" maxlength="15" />  
                                        </div>
                                        <div class="form-group">
                                            <AgBaseInputNumberComponent nom="tel" label="Téléphone" :required="true" v-model="bdObjet.tel" minlength="7" maxlength="15" />  
                                        </div>
                                        <div class="form-group">
                                            <AgBaseInputPasswordComponent nom="password" label="Mot de passe" :required="true" v-model="bdObjet.password" minlength="8" autocomplete="off" />
                                        </div>
                                        <div class="form-group">
                                            <label :for="'role_id'">
                                ...
                                <div class="col col-lg-6 col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <AgBaseInputNumberComponent nom="fax" label="Fax" v-model="bdObjet.fax" minlength="7" :required="true" maxlength="15" />  
                                        </div>
                                        <div class="form-group">
                                            <AgBaseInputPasswordComponent nom="confirm_password" label="Confirmez le mot de passe" :required="true" v-model="bdObjet.confirm_password" minlength="8" autocomplete="off" />
                                        </div>
                                    </fieldset>
                                </div>
                                 <div class="form-group">
        ...
        data() {
            return {
                ...
                listeBreadcrumbs: [
                    ...
                    {texte: "Ajouter un intervenant", nomRoute: "", parametres: {}},
                ],
            };
        },
        methods: {
            bdObjetSave() {
                ...
                DataService.create(this.bdObjet)
                        .then(response => {
                            ...
                            this.loading = false;
                            this.$router.push({name: "acl.users.list", query: { alertSucces: 'Intervenant créé avec succès' }});
                        })
                        .catch(e => {
