/**
 * Classe qui recapitules toutes les rquêtes vers le serveur
 * 
 * @type type
 */
import http from "@/http-common";
class ActeurCategorieDataService {
    nomRoute = "acteur_categories";
...
export default new ActeurCategorieDataService();